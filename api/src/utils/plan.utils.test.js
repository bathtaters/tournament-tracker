// Imports/Mocks
const { 
  getVoterSlots, getEventScores, planStatus, 
  filterUnvoted, resetEvent, slotToEvent, _unrankedEventFactor
} = require('./plan.utils');
...
describe('planStatus', () => {
  ...
  it('returns object array with planstatus and planprogress', () => {
    ...
    expect(toObjArray).toHaveBeenCalledWith({ planstatus: 1, planprogress: 50 });
