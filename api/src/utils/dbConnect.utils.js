...
exports.getConnStr = (dbUser, config = null) => {
  ...
  if (config.server)
    connStr = exports.replaceFromObj(connStr, config.server, {
      pre: "%",
      caseI: 1,
    });
  connStr = exports.replaceFromObj(connStr, userObj, {
    pre: "%",
    caseI: 1,
    esc: 1,
  });
    ...
    try {
      ...
      if (Array.isArray(retryCodes) && !retryCodes.includes(err.code)) {
        ...
        if (typeof retryCb === "function") {
          ...
          logger.warn("Attempt failed:", err.message, "Retrying...");
        }
...
const extendStackTrace = (stack, prevStack) =>
  prevStack
    ? (stack || "") +
      "\n\t--- pre-pg ---\n" +
...
exports.replaceFromObj = (str, obj, { pre, suff, notAll, caseI, esc } = {}) =>
