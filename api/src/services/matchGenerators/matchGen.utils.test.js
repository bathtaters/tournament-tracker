...
describe("combinationOps", () => {
  ...
  describe("getGroups", () => {
    it("gets groups of size 1", () => {
      ...
      expect([...getGroups(["a", "b", "c", "d"], 1)]).toEqual([
        [["a"], ["b"], ["c"], ["d"]],
      ]);
    });
    ...
    it("get single group", () => {
      ...
      expect([...getGroups(["a", "b", "c", "d"], 4)]).toEqual([
        [["a", "b", "c", "d"]],
      ]);
    });
    it("minimum width = 1", () => {
      expect([...getGroups(["a", "b", "c", "d"], 0)]).toEqual([
        [["a"], ["b"], ["c"], ["d"]],
      ]);
      expect([...getGroups(["a", "b", "c", "d"], -1)]).toEqual([
        [["a"], ["b"], ["c"], ["d"]],
      ]);
      expect([...getGroups(["a", "b", "c", "d"], -13)]).toEqual([
        [["a"], ["b"], ["c"], ["d"]],
      ]);
    });
    it("using input smaller than width", () => {
      expect([...getGroups(["a", "b"], 3)]).toEqual([[["a", "b"]]]);
      expect([...getGroups(["a", "b", "c", "d"], 8)]).toEqual([
        [["a", "b", "c", "d"]],
      ]);
...
describe("getGroupsSimple", () => {
  it("gets groups of size 1", () => {
    ...
    expect(getGroupsSimple(["a", "b", "c", "d"], 1)).toEqual([
      ["a"],
      ["b"],
      ["c"],
      ["d"],
  ...
  it("gets groups of size 2", () => {
    expect(getGroupsSimple(["a", "b", "c", "d"], 2)).toEqual([
      ["a", "b"],
      ["c", "d"],
    ]);
  });
  it("gets groups of size 3", () => {
    expect(getGroupsSimple(["a", "b", "c", "d", "e", "f"], 3)).toEqual([
      ["a", "b", "c"],
      ["d", "e", "f"],
    ]);
  });
  it("get uneven group sizes", () => {
    ...
    expect(getGroupsSimple(["a", "b", "c", "d"], 3)).toEqual([
      ["a", "b", "c"],
      ["d"],
    ]);
  });
  it("get single group", () => {
    ...
    expect(getGroupsSimple(["a", "b", "c", "d"], 4)).toEqual([
      ["a", "b", "c", "d"],
    ]);
  });
  it("minimum width = 1", () => {
    expect(getGroupsSimple(["a", "b", "c", "d"], 0)).toEqual([
      ["a"],
      ["b"],
      ["c"],
      ["d"],
    ...
    expect(getGroupsSimple(["a", "b", "c", "d"], -13)).toEqual([
      ["a"],
      ["b"],
      ["c"],
      ["d"],
  ...
  it("using input smaller than width", () => {
    ...
    expect(getGroupsSimple(["a", "b", "c", "d"], 8)).toEqual([
      ["a", "b", "c", "d"],
    ]);
