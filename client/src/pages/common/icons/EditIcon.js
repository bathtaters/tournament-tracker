...
function EditIcon({ className = "fill-current stroke-current w-3 h-3" }) {
  return (
    <svg className={className + " stroke-[10px]"} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 490.337 490.337">
      <g>
