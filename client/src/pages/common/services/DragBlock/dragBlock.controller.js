...
function useDndController(type, item, onDrop, dropCheck, droppable, draggable, disabled) {
  // Simple data
  ...
  const [{ isOver, canDrop }, drop] = useDrop(() => ({
    accept: type,
    canDrop: (dropped, monitor) => !disable && droppable && dropCheck(monitor.getItemType(), dropped, item),
