  ...
  endpoints: (build) => ({
    match: build.query({
      ...
      transformResponse: debugLogging
        ? (res) => console.log("MATCH", res) || res
        : undefined,
      providesTags: getTags(
        { Match: (r, i, a) => (r && r.eventid) || a },
        { limit: 1 }
      ),
    }),
    ...
    report: build.mutation({
      ...
      transformResponse: debugLogging
        ? (res) => console.log("REPORT", res) || res
        : undefined,
    ...
    updateMatch: build.mutation({
      ...
      transformResponse: debugLogging
        ? (res) => console.log("UPD_MATCH", res) || res
        : undefined,
      invalidatesTags: getTags(["Match", "Event", "Stats"], {
        key: "eventid",
        all: 0,
    ...
    updateDrops: build.mutation({
      ...
      transformResponse: debugLogging
        ? (res) => console.log("UPD_DROPS", res) || res
        : undefined,
      invalidatesTags: getTags(["Match", "Event", "Stats"], {
        key: "eventid",
        all: 0,
