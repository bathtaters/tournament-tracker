...
function EyeIcon({ isOpen = true, className = "w-full" }) {
  return isOpen ? (
    <svg
      className={`stroke-current fill-none h-auto ${className}`}
      version="1.1"
    ...
    >
      <path
        d="M21.0006 12.0007C19.2536 15.5766 15.8779 18 12 18M12 18C8.12204 18 4.7463 15.5766 2.99977 12.0002M12 
